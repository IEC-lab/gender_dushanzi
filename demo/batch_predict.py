...
IMAGE_LIST_FILE='/home/lc/data/gender_200w/align_gender/clean_val.txt'
DATA_ROOT='/home/lc/data/gender_200w/align_gender/'
BATCH_SIZE=200
...
def predict():
    ...
    for line in lines:
        ...
        if prediction_gender==0 and label_gender==1:
            F_Female+=1
            os.system("cp "+imgpath+" /home/lc/gender/dushanzi/demo/mis_female/")
        elif prediction_gender==1 and label_gender==0:
            F_Male+=1
            os.system("cp "+imgpath+" /home/lc/gender/dushanzi/demo/mis_male/")
        i=i+1
        print ('iter:',i)
